...
import 'package:financify_wallet/ui/pages/transfer_success_page.dart';
...
class _TransferAmountPageState extends State<TransferAmountPage> {
  ...
  Future<void> handleCheckout() async {
    ...
    final result =
        await Get.to(() => const PinPage(), arguments: {'clearPin': true});
    if (result == true) {
      await launchUrlString('https://demo.midtrans.com/');
      Get.offAll(() => const TransferSuccessPage());
    }
  }
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          CustomFilledButton(title: 'Continue', onPressed: handleCheckout),
